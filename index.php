    ...
    <div class="grid">
        ...
        <div class="sec-grid">
            <section class="flex main">
                <h1 class="title"> PRENEZ RENDEZ-VOUS PLUS RAPIDEMENT ET PLUS FACILEMENT AVEC <span class="sp">DocLib</span></h1>
        ...
        <footer class="flex">
            ...
            <p class="all-r-r">© 2023. All rights reserved.</p>
        </footer>
    </div>
</body>
</html>